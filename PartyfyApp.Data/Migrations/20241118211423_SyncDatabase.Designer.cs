...
namespace PartyfyApp.Data.Migrations
{
    ...
    [Migration("20241118211423_SyncDatabase")]
            ...
            modelBuilder.Entity("PartyfyApp.Data.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 4,
                            CreatedOn = new DateTime(2024, 11, 18, 21, 14, 22, 656, DateTimeKind.Utc).AddTicks(3177),
                            DJ = "COZTOF",
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 5,
                            CreatedOn = new DateTime(2024, 11, 18, 21, 14, 22, 656, DateTimeKind.Utc).AddTicks(3193),
                            DJ = "Pandora MC Bram",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedOn = new DateTime(2024, 11, 18, 21, 14, 22, 656, DateTimeKind.Utc).AddTicks(3197),
                            DJ = "Groky",
            ...
            modelBuilder.Entity("PartyfyApp.Data.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3f279e50-e5f8-44fc-9359-3213f3400b40"),
                            EventId = 1,
                            Price = 20.0m,
                            Quantity = 400,
                            TicketTypeId = 2
                        ...
                        new
                        {
                            Id = new Guid("1a54568e-a4b1-429c-86de-60a03197890b"),
                            EventId = 2,
                            Price = 50.0m,
                            Quantity = 30,
                            TicketTypeId = 1
                        ...
                        new
                        {
                            Id = new Guid("c1a1692a-6940-4531-af24-7228836a6327"),
                            EventId = 2,
                            Price = 30.0m,
                            Quantity = 100,
                            TicketTypeId = 2
                        ...
                        new
                        {
                            Id = new Guid("dffcdfb8-7223-42f4-a1cd-e70f9cc3214e"),
                            EventId = 3,
                            Price = 80.0m,
                            Quantity = 45,
                            TicketTypeId = 1
                        ...
                        new
                        {
                            Id = new Guid("80a13561-4c88-45fd-b5a4-0dd45e3df36b"),
                            EventId = 3,
                            Price = 50.0m,
                            Quantity = 200,
                            TicketTypeId = 2
                        ...
                        new
                        {
                            Id = new Guid("9c2937be-c506-48b5-a175-1040fb516cc8"),
                            EventId = 3,
                            Price = 20.0m,
                            Quantity = 200,
                            TicketTypeId = 3
