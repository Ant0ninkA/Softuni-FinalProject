...
namespace PartyfyApp.Data.Migrations
{
    ...
    [Migration("20241121131955_SyncDB")]
            ...
            modelBuilder.Entity("PartyfyApp.Data.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 4,
                            CreatedOn = new DateTime(2024, 11, 21, 13, 19, 53, 970, DateTimeKind.Utc).AddTicks(5786),
                            DJ = "COZTOF",
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 5,
                            CreatedOn = new DateTime(2024, 11, 21, 13, 19, 53, 970, DateTimeKind.Utc).AddTicks(5812),
                            DJ = "Pandora MC Bram",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedOn = new DateTime(2024, 11, 21, 13, 19, 53, 970, DateTimeKind.Utc).AddTicks(5818),
                            DJ = "Groky",
            ...
            modelBuilder.Entity("PartyfyApp.Data.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("53f9db80-2ceb-473b-a1a4-23fc3442e11b"),
                            EventId = 1,
                            Price = 20.0m,
                            Quantity = 400,
                            TicketTypeId = 2
                        ...
                        new
                        {
                            Id = new Guid("622ea59f-1ddf-45bd-85ff-171a30d0cbd8"),
                            EventId = 2,
                            Price = 50.0m,
                            Quantity = 30,
                            TicketTypeId = 1
                        ...
                        new
                        {
                            Id = new Guid("c71ebc63-9361-4123-802a-4945ea2b7b12"),
                            EventId = 2,
                            Price = 30.0m,
                            Quantity = 100,
                            TicketTypeId = 2
                        ...
                        new
                        {
                            Id = new Guid("9febf9f7-0f6f-4d68-83e8-8aca6a50ee68"),
                            EventId = 3,
                            Price = 80.0m,
                            Quantity = 45,
                            TicketTypeId = 1
                        ...
                        new
                        {
                            Id = new Guid("fbfe273c-4c34-4360-a1d3-e9b44c89f66b"),
                            EventId = 3,
                            Price = 50.0m,
                            Quantity = 200,
                            TicketTypeId = 2
                        ...
                        new
                        {
                            Id = new Guid("a96e2d29-f9fa-4709-8cff-8e43c1af93df"),
                            EventId = 3,
                            Price = 20.0m,
                            Quantity = 200,
                            TicketTypeId = 3
